...
<div class="col-md-12">
    ...
    <div class="card">
        <form id="formManufacturer" method="post" action="{{ route('admin.manufacturers.store') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
...
<script>
    $(document).ready( function () {
        ...
        $("#formManufacturer").submit(function(e) {
            ...
            $.ajax({
                ...
                {
                    showNotification('top','right', 'successfully added new manufacturer.', 'success');
                },
                error: function (response) {
                    showNotification('top','right', 'added new manufacturer failed.', 'danger');
                },
            });
